...
<div class="row mb-3">
	...
	<div class="col-sm-9 text-secondary">
		<input type="text" name="process_steps"  class="form-control" value="{{ $siteinfo->process_steps }}" >
	</div>
</div>
 ...
 <div class="row mb-3">
	...
	<div class="col-sm-9 text-secondary">
		<input type="text" name="instagrm_link"  class="form-control" value="{{ $siteinfo->instagrm_link }}" >
	</div>
</div>
