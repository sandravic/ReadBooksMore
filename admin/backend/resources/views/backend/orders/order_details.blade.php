                        ...
                        <div class="card">
                            <div class="card-body">
                                <ul class="list-group">
                                    ...
                                    <li class="list-group-item">
                                        <strong><span class="text-dark">Rental Days :</span></strong>
                                        {{ $order->rental_period }}
                                    </li>
                                    <li class="list-group-item">
                                        <strong><span class="text-dark">Rental Start Date :</span></strong>
                                        {{ $order->rental_start_date }}
                                    </li>
                                    <li class="list-group-item">
                                        <strong><span class="text-dark">Rental End Date :</span></strong>
                                        {{ $order->rental_end_date }}
                                    </li>
                                    <li class="list-group-item">
                                        <strong><span class="text-dark">Price :</span></strong>
                                        {{ $order->price }}
                                    </li>
                                    <li class="list-group-item">
